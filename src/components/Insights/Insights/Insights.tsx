...
import InsightsRankingTable from "../InsightsRankingTable/InsightsRankingTable";
import ContestantDetailPanel from "../ContestantDetailPanel/ContestantDetailPanel";
