...
vi.mock("../InsightsRankingTable/InsightsRankingTable", () => ({ default: () => <div>ranking-table</div> }));
vi.mock("../ContestantDetailPanel/ContestantDetailPanel", () => ({ default: () => <div>contestant-panel</div> }));
